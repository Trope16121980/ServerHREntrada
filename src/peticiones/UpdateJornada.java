...
public class UpdateJornada {
    ...
    public static ArrayList<Jornada> updateJornada(String crud, String nombreTabla,
            ...
            if (!rsNom.next()) {
                ...
                try {
                    ...
                    if (!rsHorasalida.next()) {
                        Errores error = new Errores();
                        String errorUpdateJornadaDni = error.errorUpdateJornadaDni();
                        System.out.println(errorUpdateJornadaDni);
                        outObjeto = new ObjectOutputStream(client.getOutputStream());
                        outObjeto.writeObject(errorUpdateJornadaDni);
                        outObjeto.flush();
                    } else {
                        psHorasalida.close();
